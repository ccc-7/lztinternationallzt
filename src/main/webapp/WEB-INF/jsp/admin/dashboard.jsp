    ...
    <main class="content">
        ...
        <div class="admin-content">
            ...
            <section class="panel dashboard-intro">
                ...
                <p>Application pipeline, TA workload, and popular jobs — rendered locally with no external chart libraries.</p>
            ...
            <div class="dashboard-charts dashboard-grid">
                ...
                <section class="panel chart-panel">
                    ...
                    <div class="panel-header">
                        ...
                        <p class="panel-subtitle">Share of all applications by status</p>

                    </div>

                    <c:choose>

                        <c:when test="${stats.totalApplications > 0}">

                            <div class="chart-bars">

                                <div class="chart-bar-row">

                                    <span class="chart-bar-label">Pending</span>

                                    <div class="chart-bar-track">

                                        <div class="chart-bar-fill pending" style="width: ${stats.pendingApplications * 100 / stats.totalApplications}%"></div>

                                    </div>

                                    <span class="chart-bar-value">${stats.pendingApplications}</span>

                                </div>

                                <div class="chart-bar-row">

                                    <span class="chart-bar-label">Interview</span>

                                    <div class="chart-bar-track">

                                        <div class="chart-bar-fill interview" style="width: ${stats.interviewApplications * 100 / stats.totalApplications}%"></div>

                                    </div>

                                    <span class="chart-bar-value">${stats.interviewApplications}</span>

                                </div>

                                <div class="chart-bar-row">

                                    <span class="chart-bar-label">Accepted</span>

                                    <div class="chart-bar-track">

                                        <div class="chart-bar-fill accepted" style="width: ${stats.acceptedApplications * 100 / stats.totalApplications}%"></div>

                                    </div>

                                    <span class="chart-bar-value">${stats.acceptedApplications}</span>

                                </div>

                                <div class="chart-bar-row">

                                    <span class="chart-bar-label">Rejected</span>

                                    <div class="chart-bar-track">

                                        <div class="chart-bar-fill rejected" style="width: ${stats.rejectedApplications * 100 / stats.totalApplications}%"></div>

                                    </div>

                                    <span class="chart-bar-value">${stats.rejectedApplications}</span>
                            ...
                            <div class="chart-legend">
                                ...
                                <span><i class="legend-dot interview"></i> Interview</span>
                ...
                <section class="panel chart-panel">
                    ...
                    <div class="panel-header">
                        ...
                        <h2>TA Workload by Accepted Hours</h2>

                        <p class="panel-subtitle">Accepted assignments only · scale 0–${maxWorkloadHours}h</p>

                    </div>

                    <c:choose>

                        <c:when test="${not empty taUsers}">

                            <div class="chart-bars">

                                <c:forEach var="ta" items="${taUsers}">

                                    <c:set var="hours" value="${workloads[ta.userId]}" />

                                    <c:set var="hourCount" value="${hours != null ? hours : 0}" />

                                    <div class="chart-bar-row">

                                        <span class="chart-bar-label" title="${ta.userId}">${ta.displayName}</span>

                                        <div class="chart-bar-track">

                                            <c:choose>

                                                <c:when test="${hourCount > 40}">

                                                    <div class="chart-bar-fill workload-overloaded" style="width: ${hourCount * 100 / maxWorkloadHours}%"></div>

                                                </c:when>

                                                <c:when test="${hourCount > 20}">

                                                    <div class="chart-bar-fill workload-warning" style="width: ${hourCount * 100 / maxWorkloadHours}%"></div>

                                                </c:when>

                                                <c:otherwise>

                                                    <div class="chart-bar-fill workload-normal" style="width: ${hourCount * 100 / maxWorkloadHours}%"></div>
                                        ...
                                        <span class="chart-bar-value">${hourCount}h</span>
                        ...
                        <c:otherwise>
                            ...
                            <div class="empty-state-small">No TA accounts found</div>
                ...
                <section class="panel chart-panel">
                    ...
                    <div class="panel-header">
                        ...
                        <p class="panel-subtitle">Top 5 by application count</p>

                    </div>

                    <c:choose>

                        <c:when test="${not empty stats.topJobs}">

                            <div class="chart-bars">

                                <c:forEach var="entry" items="${stats.topJobs}">

                                    <div class="chart-bar-row">

                                        <span class="chart-bar-label chart-bar-label-job" title="${entry.key}">

                                            ${stats.topJobTitles[entry.key]}

                                        </span>

                                        <div class="chart-bar-track">

                                            <div class="chart-bar-fill jobs" style="width: ${entry.value * 100 / maxJobApplicants}%"></div>
                        ...
                        <c:otherwise>
                            ...
                            <div class="empty-state-small">No job applications yet</div>
